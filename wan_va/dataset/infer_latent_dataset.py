...
def construct_lerobot_multi_processor(config, 
    ...
    return datasets_out_lst, repo_list
...
class InferMultiLatentLeRobotDataset(torch.utils.data.Dataset):
    ''''
    ...
    def __init__(
        ...
        self._datasets, self.repo_list = construct_lerobot_multi_processor(config, 
                                                           num_init_worker, 
                                                           )
    ...
    def __getitem__(self, idx) -> dict:
        ...
        return cur_dset[local_idx], self.repo_list[self.item_id_to_dataset_id[idx]]
